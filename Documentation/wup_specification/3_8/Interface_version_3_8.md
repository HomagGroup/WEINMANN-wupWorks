...
<table class="toc-table">
  ...
  <tr><td class="toc-left toc-indent-2"><a href="#3.3.9-interface-version-3.8">3.3.9 Interface version 3.8</a></td><td class="toc-right">24</td></tr>
  ...
  <tr><td class="toc-left toc-indent-1"><a href="#8.6-example-nr-with-rotation">8.6 Example NR with rotation (tilted and rotated nailing)</a></td><td class="toc-right">73</td></tr>
</table>

<h2 id="1-intended-use">1 Intended use</h2>

Interface description for prefabricated house elements
<p><img src="Interface_version_3_8_images/page_001_img_004.png" style="width:71.5%;"></p>
...
<p><img src="Interface_version_3_8_images/page_008_img_020.png" style="width:14.7%;"></p>

<p><em>ELM reference (lx, by, xoffset, yoffset):</em></p>
<p><img src="Interface_version_3_8_images/page_024_img_078.png" style="width:45.0%;"></p>
...
<p><img src="Interface_version_3_8_images/page_009_img_024.png" style="width:66.7%;"></p>
...
<p><img src="Interface_version_3_8_images/page_010_img_028.png" style="width:66.7%;"></p>
...
<p><img src="Interface_version_3_8_images/page_011_img_032.png" style="width:66.5%;"></p>
...
<p><img src="Interface_version_3_8_images/page_012_img_041.png" style="width:27.5%;"></p>
<p><img src="Interface_version_3_8_images/page_012_img_042.png" style="width:27.5%;"></p>
<p><img src="Interface_version_3_8_images/page_012_img_043.png" style="width:27.5%;"></p>
<p><img src="Interface_version_3_8_images/page_012_img_044.png" style="width:27.4%;"></p>
<p><img src="Interface_version_3_8_images/page_012_img_045.png" style="width:27.6%;"></p>
<p><img src="Interface_version_3_8_images/page_012_img_046.png" style="width:27.7%;"></p>
...
<p><img src="Interface_version_3_8_images/page_013_img_051.png" style="width:48.3%;"></p>

Transformation of the original plane via rotation around the Z axis

<p><img src="Interface_version_3_8_images/page_013_img_052.png" style="width:64.4%;"></p>

---

Transformation of the plane via tilting around the X' axis

<p><img src="Interface_version_3_8_images/page_014_img_056.png" style="width:64.4%;"></p>
...
<h4 id="3.3.9-interface-version-3.8">3.3.9 Interface version 3.8</h4>

- NR parameter extended to support tilted and rotated nailing:
  - New optional parameters `rx`, `ry`, `rz` for the NR command (rotation around the X, Y, and Z axes of the nail coordinate system).
  - Enables nailing with arbitrary 3D orientation of the nail (tilted and rotated nailing).
  - **Note:** These parameters may only be used after consultation with WEINMANN, as they depend on the specific machine equipment.
...
| :---	|	:---	|	:---	|	:--- |
|VERSION | integer.integer[.integer] | |Version using Semantic Versioning. <br> Example: 3.8|
...
<p><img src="Interface_version_3_8_images/page_027_img_086.png" style="width:96%;"></p>

<p><strong>BT6 geometry (large view)</strong></p>
<p><img src="Interface_version_3_8_images/page_028_img_090.png" style="width:96%;"></p>
...
|NR|xa, ya, xe, ye, a, i [, rx [, ry [, rz]]]|Nail line definition. Optional rotation parameters rx, ry, rz define the nail angle around the X, Y and Z axis respectively.|
...
> **⚠ Note:** The optional rotation parameters `rx`, `ry` and `rz` of the NR command may only be used after explicit **consultation with WEINMANN**, as they depend on the specific machine equipment and configuration. Not every machine supports tilted and rotated nailing.

NR rotation parameter meaning:

| Parameter | Type | Default | Meaning |
|:---|:---|:---|:---|
|rx|float|{0}|Rotation angle around the X axis of the nail coordinate system (tilt in X direction). Positive direction: mathematically positive (counter-clockwise when viewing along X toward the origin).|
|ry|float|{0}|Rotation angle around the Y axis of the nail coordinate system (tilt in Y direction). Positive direction: mathematically positive (counter-clockwise when viewing along Y toward the origin).|
|rz|float|{0}|Rotation angle around the Z axis of the nail coordinate system (rotation in the panel plane). Positive direction: mathematically positive (counter-clockwise when viewing along Z toward the origin).|
...
|NR rotation default|If rx, ry, rz are omitted, the nail is driven perpendicularly to the panel surface (rx = ry = rz = 0).|
|NR rotation machine dependency|rx, ry, rz may only be used after consultation with WEINMANN. Machine support is required.|
...
<p><img src="Interface_version_3_8_images/page_047_img_130.png" style="width:96%;"></p>
...
<p><img src="Interface_version_3_8_images/page_048_img_134.png" style="width:71.5%;"></p>
...
<p><img src="Interface_version_3_8_images/tongue_groove_index_5_4_1.svg" style="width:96%;"></p>
...
<p><img src="Interface_version_3_8_images/page_053_img_147.png" style="width:71.5%;"></p>

Undercut: control code: xx2x

<p><img src="Interface_version_3_8_images/page_053_img_148.png" style="width:71.5%;"></p>
...
<p><img src="Interface_version_3_8_images/page_054_img_153.png" style="width:71.4%;"></p>
...
Bearbeitungsrichtung
<p><img src="Interface_version_3_8_images/page_054_img_154.png" style="width:71.1%;"></p>
...
Bearbeitungsrichtung 
<p><img src="Interface_version_3_8_images/page_055_img_160.png" style="width:71.3%;"></p>
...
|  |  |   
|:---	|	:---	|	
|Circular notch in a clockwise direction PAF MP 3382,40,34,18,211;|<p><img src="Interface_version_3_8_images/page_057_img_169.png" style="width:100%;"></p>|
|Closed, rectangular notch <ul><li>PAF</li><li>PP 65,2201,34,121,0;</li><li> PP 133,2201,34,121,0; </li><li>PP 133,2269,34,121,0; </li><li>PP 65,2269,34,121,0;</li><li> PP 65,2201,34,121,0;</li></ul>|<p><img src="Interface_version_3_8_images/page_057_img_170.png" style="width:100%;"></p>|
|Notch with arc <ul><li>PAF</li><li> PP 2000,0,16,211,0; </li><li>PP 2000,1800,16,211,0;</li><li> KB 3000,1800,800,</li><li>Acw,16,211,0;</li><li> PP 3000,0,16,211,0;</li></ul>|<p><img src="Interface_version_3_8_images/page_057_img_171.png" style="width:100%;"></p>|
...
<p><img src="Interface_version_3_8_images/page_064_img_187.png" style="width:66.9%;"></p>
...
<p><img src="Interface_version_3_8_images/page_065_img_191.png" style="width:66.6%;"></p>
...
<p><img src="Interface_version_3_8_images/page_066_img_196.png" style="width:71.5%;"></p>


Negative tilt angle: counter-clockwise in the direction of the processing line

<p><img src="Interface_version_3_8_images/page_066_img_197.png" style="width:71.5%;"></p>
...
<p><img src="Interface_version_3_8_images/page_067_img_201.png" style="width:9.5%;"></p>
...
<p><img src="Interface_version_3_8_images/page_073_img_215.png" style="width:70.1%;"></p>

---

<h3 id="8.6-example-nr-with-rotation">8.6 Example NR with rotation (tilted and rotated nailing)</h3>

> **⚠ Note:** The rotation parameters `rx`, `ry`, `rz` may only be used after **consultation with WEINMANN**, as they depend on the specific machine equipment.

**Standard nail line (no rotation) – reference case**

A straight nail line along the X direction with spacing 250 mm, no rotation:

```text
PLI1 2600,2600,15,0,0,40,chipboard,0;
NR 100,48,2500,48,250,10;
```

**Nail point with tilt around X axis (rx = 15°)**

A single nail point tilted 15° around the X axis (angled toward Y direction):

```text
PLI1 2600,2600,15,0,0,40,chipboard,0;
NR 344,500,344,500,1,10,15,0,0;
```

*Interpretation:* The nail is driven at 15° tilt relative to the panel normal, rotating around the X axis of the nail coordinate system.

**Nail point with tilt around Y axis (ry = –10°)**

A single nail point tilted –10° around the Y axis (angled toward X direction):

```text
PLI1 2600,2600,15,0,0,40,chipboard,0;
NR 344,500,344,500,1,10,0,-10,0;
```

**Nail line with combined tilt and rotation (rx = 15°, rz = 30°)**

A nail line with spacing 200 mm, tilted 15° around X and rotated 30° around Z in the panel plane (useful for angled structural connections):

```text
PLI1 2600,2600,15,0,0,40,chipboard,0;
NR 100,100,2400,100,200,10,15,0,30;
```

*Interpretation:* Each nail along the line is tilted 15° around X and the nail pattern is rotated 30° in the panel plane.

**Complete element section example with rotated nailing**

```text
VERSION 3.8;
ELEMENTID a1b2c3d4-0000-4000-8000-000000000001;
ANR Order 2026-1;
ELB WALL-ROT-NAIL;
ELN wn001;
ELM 3000,2700,200,1;

PLI1 2800,2600,15,100,50,40,chipboard-rotated-nail,0;
PP 100,50,15,0,0,0;
PP 2900,50,15,0,0,0;
PP 2900,2650,15,0,0,0;
PP 100,2650,15,0,0,0;
PP 100,50,15,0,0,0;
NR 200,100,2700,100,250,10,15,0,0;
NR 200,2500,2700,2500,250,10,-15,0,0;
NR 500,500,500,500,1,10,0,10,45;
```

*Notes on the example:*
- First NR line: nail line at y=100, tilted 15° around X axis, spacing 250 mm.
- Second NR line: nail line at y=2500, tilted –15° around X axis (mirror image), spacing 250 mm.
- Third NR: single nail point at (500, 500), tilted 10° around Y and rotated 45° in the panel plane (ry=10, rz=45).
