...
public class SiteBrokerClientService : ISiteBrokerClientService, IDisposable
{
    ...
    public SiteBrokerClientService(IMqttClientService mqttClientService, IOptions<SiteBrokerOptions> options)
    {
        ...
        _orderLoadTopic = OrderTopicHelper.GetOrderLoadTopic(_options.Value.MachineNumber, Constants.Wildcard, Constants.Wildcard);
        _batchPrepareTopic = OrderTopicHelper.GetBatchPrepareTopic(_options.Value.MachineNumber, Constants.Wildcard, Constants.Wildcard);
        _batchVariantProduceTopic = OrderTopicHelper.GetBatchVariantProduceTopic(_options.Value.MachineNumber, Constants.Wildcard, Constants.Wildcard);
    }
    ...
    public async Task SendOrderLoadedResponse(Guid orderId, OrderStatus orderStatus)
    {
        ...
        var orderLoadedTopic = OrderTopicHelper.GetOrderLoadedTopic(_options.Value.MachineNumber, Constants.Orchestrator, orderId.ToString());
    ...
    public async Task SendBatchPreparedResponse(Guid batchId, Guid orderId, BatchStatus batchStatus)
    {
        ...
        var batchPreparedTopic = OrderTopicHelper.GetBatchPreparedTopic(_options.Value.MachineNumber, Constants.Orchestrator, batchId.ToString());
    ...
    public async Task SendBatchVariantExecutedResponse(Guid batchVariantId, Guid batchId, Guid orderId, RunStatus runStatus)
    {
        ...
        var batchVariantProducedTopic = OrderTopicHelper.GetBatchVariantProducedTopic(_options.Value.MachineNumber, Constants.Orchestrator, batchVariantId.ToString());
    ...
    public async Task SendOnlineModeResponse(bool onlineModeEnabled)
    {
        ...
        var onlineModeTopic = OrderTopicHelper.GetOnlineModeTopic(_options.Value.MachineNumber, Constants.Orchestrator);
    ...
    {
        var orderLoadedTopic = OrderTopicHelper.GetOrderLoadTopic(_options.Value.MachineNumber, orchestrator, orderId.ToString());
    ...
    {
        var batchPreparedTopic = OrderTopicHelper.GetBatchPrepareTopic(_options.Value.MachineNumber, orchestrator, batchId.ToString());
    ...
    {
        var batchVariantProducedTopic = OrderTopicHelper.GetBatchVariantProduceTopic(_options.Value.MachineNumber, orchestrator, batchVariantId.ToString());
