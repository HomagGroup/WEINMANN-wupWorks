...
using Wup.Works.SiteBroker.Client.Demo.Machine;
...
// Registers the public site-broker API. For the machine role we only use the
// ISiteBrokerClientService that this call provides.
